...
<script>
  //-----------------------------------------------------------------------------------------------------------------------------//
    ...
    $("#frmCadastroEtapaProjeto #drPrevistaTermino").kendoMaskedTextBox({
      format: "dd/MM/yyyy";
    })
    ...
    if($("#frmCadastroEtapaProjeto #idEtapaProjeto").val() != ''){
      $("#frmCadastroEtapaProjeto #BarAcoes").data("kendoToolBar").enable("BtnExlcuir", true);
    }
  ...
  <div class="k-form">
    ...
    <table width="100%" border="0" cellspacing="2" cellpadding="0" >
      <tr>
        ...
        <td style="width: 120px; text-align: right;">Id Responsavel:</td>
        <td>
    ...
    <table idth="100%" border="0" cellspacing="2" cellpadding="0" >
      <tr>
        ...
        <td>
          <input type="text" name="dtPrevistaInicio" id="dtPrevistaInicio" class="k-textbox" style="width: 100px;" value="'<?php  echo $objTbEtapaProjeto->Get('dtprevistainicio')?>">
        </td>
        <td style="width: 120px; text-align: right;">Data Prevista Termino</td>
        <td>
          <input type="text" name="dtPrevistaTermino" id="dtPrevistaTermino" class="k-textbox" style="width: 100px;" value="'<?php  echo $objTbEtapaProjeto->Get('dtprevistatermino')?>">
        </td>
      </tr>
    </table>
    <table>
      <tr>
        ...
        <td>
          <select name="flStatus" id="flStatus" style="width: 100px;">
						<option value="NI" <?php echo $objTbProjeto->Get('flstatus') == 'NI' ? 'selected' : '' ?> >Nao Iniciado</option>
						<option value="EA" <?php echo $objTbProjeto->Get('flstatus') == 'EA' ? 'selected' : '' ?> >Em Andamento</option>
